...
# This file is a modified version of the run_language_modeling.py script found here:
# https://github.com/huggingface/transformers/blob/master/examples/run_language_modeling.py
#
# The script has been modified in the following ways:
# - the train and validation loss is logged to file after each epoch
# - the evaluation is done on a single GPU rather than multi-GPU to avoid some bugs
# - added a BscoreCharDataset class to allow use with a custom tokenizer
# - the load_and_cache_examples() function has been modified
#
# TJ Tsai 03/2020
"""
...
class BscoreCharDataset(Dataset):
    # This class has been added to use a customized tokenizer.
...
def load_and_cache_examples(args, tokenizer, evaluate=False):
    # This function has been modified in the following ways:
    #  - the LineByLineTextDataset has been replaced with BscoreCharDataset
    #  - additional code has been has been added to ignore incomplete batches
    file_path = args.eval_data_file if evaluate else args.train_data_file
    if args.line_by_line:
        #return LineByLineTextDataset(tokenizer, args, file_path=file_path, block_size=args.block_size)
        dataset = BscoreCharDataset(args, file_path=file_path)
    else:
                ...
                if args.local_rank in [-1, 0] and args.logging_steps > 0 and global_step % args.logging_steps == 0:
                    ...
                    if (
                        ...
                        results = evaluate(args, model, tokenizer, global_step=global_step,
                                           tr_loss=(tr_loss - logging_loss) / args.logging_steps) # added global_step, tr_loss arg -TJ
...
def main():
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        for checkpoint in checkpoints:
            ...
            model.to(args.device)
            result = evaluate(args, model, tokenizer, global_step=global_step, tr_loss = tr_loss, prefix=prefix) # added global_step arg -TJ
